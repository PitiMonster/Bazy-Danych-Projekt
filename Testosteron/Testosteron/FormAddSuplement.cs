...
{
    public partial class FormAddSuplement : Form
    {
        public FormAddSuplement()
        {
            InitializeComponent();
        }
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                LoginForm.db.dodaj_suplement(type, name, desc, price, amount);
                MessageBox.Show("dodano suplement!");
                this.Close();
            }
        }
    }
